...
console.log("=== АНАЛИЗ ВСЕХ ТЕСТОВ ===");
for (const testCase of testCases) {
  ...
  console.log(`  Expected: "${testCase.expected}" (${testCase.expected.length} chars)`);
  console.log(`  Difference: ${testCase.expected.length - encoded.length} chars`);
  console.log();
}